...
const FormInput = forwardRef(
  (
    ...
    // Solo resalta en rojo si el error es de tipo formato o requerido
    const isFieldError = error && (error.type === "pattern" || error.type === "required");
    const errorLabel = isFieldError
